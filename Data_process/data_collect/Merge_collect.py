...
from Data_process.data_collect.Merge_process import Merge_GraphText
...
class Merge_PygDataset(MSAPygDataset):
    def __init__(self,
                ...
                self.GP = Merge_GraphText(self.text_graph, self.spectrum_graph)
                #self.GP = self.spectrum_graph
