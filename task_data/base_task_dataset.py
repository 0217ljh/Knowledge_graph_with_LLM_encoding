...
class BasePygDataset(InMemoryDataset, ABC):
    ...
    def get_information_pyg(self,):
        ...
        Inf_dict = {'Name' : '样本名称','edge_ID' : '边标签','edge_attributes':'边属性','edge_index':'邻接矩阵','edge_text_feat':'边文本信息矩阵','node_ID':'节点标签','node_attributes':'节点属性','node_name':'节点名称','node_text_feat':'节点文本信息矩阵','x':'节点记号','y':'编码分类标签','y_label':'原始分类标签'}
